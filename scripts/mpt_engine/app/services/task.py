...
def generate_subtitle(task_id, params, video_script, sub_maker, audio_file):
    ...
    Custom audio has no Edge subtitle maker, so it falls back to Whisper.
    Returns:
    ...
    elif subtitle_provider == "edge" and sub_maker is None:
        subtitle_fallback = True
        logger.info("custom audio has no Edge subtitle maker, fallback to whisper")
